...
const HeroCarouselCard = ({ children, className = '' }: HeroCarouselCardProps) => {
  return (
    <div className={`relative w-full max-w-3xl pointer-events-auto ${className}`}>
      <div className="relative flex min-h-[500px] md:min-h-[580px] lg:h-[620px] flex-col rounded-[32px] border border-white/20 bg-gradient-to-br from-white/92 via-white/80 to-accent-50/70 p-4 md:p-6 shadow-[0_30px_80px_-45px_rgba(15,23,42,0.45)] backdrop-blur-xl">
